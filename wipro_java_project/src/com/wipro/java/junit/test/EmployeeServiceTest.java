...
public class EmployeeServiceTest {
    ...
    public void setUp() {
        ...
        m.addEmployee(new Employee(1, "Pradeep", "IT", 50000.0, LocalDate.of(2022, 1, 10)));
    ...
    public void testFilterByDepartment() {
        ...
        assertEquals("Pradeep", itEmployees.get(0).getName());
    }

    @Test
    public void testSortByName() {
        List<Employee> sortedEmployees = m.sortByName();
       // assertEquals("Pradeep", sortedEmployees.get(0).getName());
        assertEquals("Pradeep", sortedEmployees.get(1).getName());
